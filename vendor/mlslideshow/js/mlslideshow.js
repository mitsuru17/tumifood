...
;(function(window) {
	...
	MLSlideshow.prototype._init = function() {
		var self = this,
			onPreload = function() {
				self.el.classList.add('MLslideshow--loaded');
				// Set class current to the current slide.
				self.slides[self.current].classList.add('MLslide--current');
			};
	...
	MLSlideshow.prototype._navigate = function(direction) {
		...
		var self = this,
			...
			// currentTitle = currentSlide.querySelector('.MLslide__title');
		...
		var nextSlide = this.slides[this.current],
			...
			// nextTitle = nextSlide.querySelector('.MLslide__title');

		// Animate the nextSlide´s items in..
		var animateIn = function() {
			clearTimeout(self.navtime);

			var inItems = [].slice.call(nextSlide.querySelectorAll('.MLslide-imgwrap .MLslide__img-inner')),
			...
			nextSlide.classList.add('MLslide--current');
		...
		var outItems = [].slice.call(currentSlide.querySelectorAll('.MLslide-imgwrap .MLslide__img-inner')),
			...
			animeOutProps = {
				...
				complete: function() {
					currentSlide.classList.remove('MLslide--current');
				}
			};
